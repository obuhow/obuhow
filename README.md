...
**Ссылки:**
- 🚀 Live demo: [http://195.19.20.116](http://195.19.20.116) // в течение 25.08.2026 возможна недоступность из-за технических работ
- 🌐 Swagger UI: [http://195.19.20.116:8081/swagger-ui/index.html](http://195.19.20.116:8081/swagger-ui/index.html) // в течение 25.08.2026 возможна недоступность из-за технических работ
...
- Разрабатываю по SDD (Spec-Driven Development) с применением скиллов
- Разрабатываю на тех языках и с применением тех фреймворков, которые знаю, и на которых есть самостоятельный опыт
- Использую свои VPS везде, где возможно, для минимизации зависимостей от внешних поставщиков услуг
- Использую доступные бесплатно LLM (Nemotron Ultra, Gemini Flash, Hy3) для работы над приложением. Платные более мощные LLM подключаю, если бесплатная сеть не справляется (GPT 5.6 Luna, Terra, Claude Sonnet, Opus), либо для ревью кода и архитектуры (Claude Opus, Kimi K3)
